# Generated by Django 5.1.4 on 2024-12-20 23:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_sector', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='produit.businesssector', verbose_name="Secteur d'activité")),
                ('supplier_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='produit.suppliertype', verbose_name='Type de fournisseur')),
            ],
            options={
